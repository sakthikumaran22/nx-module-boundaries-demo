...
import { BankAccount, AccountHolder, UpdateAccountSettingsRequest } from './accounts.models';
...
export class AccountsApiService {
  ...
  getAccounts(customerId: string): Observable<BankAccount[]> {
    return this.api.get<BankAccount[]>(ACCOUNTS_API, { params: { customerId } });
  }
  ...
  updateSettings(request: UpdateAccountSettingsRequest): Observable<BankAccount> {
