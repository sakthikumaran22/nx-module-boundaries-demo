    ...
    <div class="dashboard">
      <div class="dashboard-header">
        ...
        @if (!facade.isLoading()) {
          <div class="total-balance">
            Total Balance:
            <strong>{{ formatAmount(facade.totalBalance(), "GBP") }}</strong>
          </div>
        }
      </div>
      ...
      @if (!facade.isLoading()) {
        <div class="account-grid">
          @for (account of facade.activeAccounts(); track account) {
            <div
              class="account-card"
            ...
            >
              ...
              <div class="sort-code">
                Sort: {{ formatCode(account.sortCode) }}
              </div>
              <div class="balance">
              ...
              <div class="available-balance">
                Available:
                {{
                  formatAmount(account.availableBalance, account.currencyCode)
                }}
              </div>
            </div>
          }
